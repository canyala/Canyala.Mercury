...
namespace Canyala.Mercury.Rdf
{
    ...
    public class Sparql : Parser<Query.Builder>
    {
        ...
        public static bool Translate(string sparql, Query query, out string errMsg)
        {
            ...
            {
                query.Plan = queryBuilder.FinalizedPlan;
        ...
        public static Table Query(Dataset dataset, string sparql)
        {
            string errMsg;
            var query = new Query();
            if (!Sparql.Translate(sparql, query, out errMsg))
        ...
        */
        ...
        static readonly Func<Production> QueryUnit = () => _("QueryUnit", _Query);
        
        // [2]  	Query	  ::=  	Prologue ( SelectQuery | ConstructQuery | DescribeQuery | AskQuery ) ValuesClause
        static readonly Func<Production> _Query = () => _("Query", All(Prologue, CUT, AnyOf(SelectQuery, ConstructQuery, DescribeQuery, AskQuery), CUT, ValuesClause));

        // [3] ROOT! UpdateUnit	  ::=  	Update
        static readonly Func<Production> UpdateUnit = () => Update;

        // [4]  	Prologue	  ::=  	( BaseDecl | PrefixDecl )*
        static readonly Func<Production> Prologue = () => ZeroOrMore(AnyOf(BaseDecl, PrefixDecl));

        // [5]  	BaseDecl	  ::=  	'BASE' IRIREF
        static readonly Func<Production> BaseDecl = () => _("BaseDecl", All(i("BASE"), Named("base", IRIREF), @Base));

        // [6]  	PrefixDecl	  ::=  	'PREFIX' PNAME_NS IRIREF
        static readonly Func<Production> PrefixDecl = () => _("PrefixDecl", All(i("PREFIX"), Named("prefix", PNAME_NS), Named("namespace",IRIREF), @PrefixAndNamespace));

        // [7]  	SelectQuery	  ::=  	SelectClause DatasetClause* WhereClause SolutionModifier
        static readonly Func<Production> SelectQuery = () => _("SelectQuery", All(SelectClause, ZeroOrMore(DatasetClause), WhereClause, SolutionModifier));

        // [8]  	SubSelect	  ::=  	SelectClause WhereClause SolutionModifier ValuesClause
        static readonly Func<Production> SubSelect = () => _("SubSelect", All(SelectClause, WhereClause, SolutionModifier, ValuesClause));
        ...
        static readonly Func<Production> DescribeQuery = () =>
            _("DescribeQuery", All(Named("operation", i("DESCRIBE")), @GroupOperation, AnyOf(ZeroOrMore(VarOrIri), '*'), ZeroOrMore(DatasetClause), Optional(WhereClause), SolutionModifier));
        
        /// <summary>
        /// [12]  	AskQuery	  ::=  	'ASK' DatasetClause* WhereClause SolutionModifier
        /// </summary>
        static readonly Func<Production> AskQuery = () => _("AskQuery", All(Named("operation", i("ASK")), @GroupOperation, ZeroOrMore(DatasetClause), WhereClause, SolutionModifier));

        /// <summary>
        /// [13]  	DatasetClause	  ::=  	'FROM' ( DefaultGraphClause | NamedGraphClause )
        /// </summary>
        static readonly Func<Production> DatasetClause = () => _("DatasetClause", All(i("FROM"), AnyOf(DefaultGraphClause, NamedGraphClause)));

        /// <summary>
        /// [14]  	DefaultGraphClause	  ::=  	SourceSelector
        /// </summary>
        static readonly Func<Production> DefaultGraphClause = () => _("DefaultGraphClause", SourceSelector);

        /// <summary>
        /// [15]  	NamedGraphClause	  ::=  	'NAMED' SourceSelector
        /// </summary>
        static readonly Func<Production> NamedGraphClause = () => _("NamedGraphClause", All(i("NAMED"), SourceSelector));

        /// <summary>
        /// [16]  	SourceSelector	  ::=  	iri
        /// </summary>
        static readonly Func<Production> SourceSelector = () => _("SourceSelector", iri);

        /// <summary>
        /// [17]  	WhereClause	  ::=  	'WHERE'? GroupGraphPattern
        /// </summary>
        static readonly Func<Production> WhereClause = () => _("WhereClause", All(Optional(i("WHERE")), GroupGraphPattern));

        /// <summary>
        /// [18]  	SolutionModifier	  ::=  	GroupClause? HavingClause? OrderClause? LimitOffsetClauses?
        /// </summary>
        static readonly Func<Production> SolutionModifier = () => _("SolutionModifier", All(Optional(GroupClause), Optional(HavingClause), Optional(OrderClause), Optional(LimitOffsetClauses)));

        /// <summary>
        /// [19]  	GroupClause	  ::=  	'GROUP' 'BY' GroupCondition+
        /// </summary>
        static readonly Func<Production> GroupClause = () => _("GroupClause", All(i("GROUP"), i("BY"), OneOrMore(GroupCondition)));
        ...
        /// </summary>
        static readonly Func<Production> HavingClause = () => _("HavingClause", All(i("HAVING"), OneOrMore(HavingCondition)));

        /// <summary>
        /// [22]  	HavingCondition	  ::=  	Constraint
        /// </summary>
        static readonly Func<Production> HavingCondition = () => _("HavingCondition", All(Constraint, @Having));

        /// <summary>
        /// [23]  	OrderClause	  ::=  	'ORDER' 'BY' OrderCondition+
        /// </summary>
        static readonly Func<Production> OrderClause = () => _("OrderClause", All(i("ORDER"), i("BY"), OneOrMore(OrderCondition)));
        ...
        static readonly Func<Production> LimitOffsetClauses = () => 
            _("LimitOffsetClauses", AnyOf(All(LimitClause, Optional(OffsetClause)), All(OffsetClause, Optional(LimitClause))));

        /// <summary>
        /// [26]  	LimitClause	  ::=  	'LIMIT' INTEGER
        /// </summary>
        static readonly Func<Production> LimitClause = () => _("LimitClause", All(i("LIMIT"), Named("limit", INTEGER), @Limit));

        /// <summary>
        /// [27]  	OffsetClause	  ::=  	'OFFSET' INTEGER
        /// </summary>
        static readonly Func<Production> OffsetClause = () => _("OffsetClause", All(i("OFFSET"), Named("offset", INTEGER), @Offset));

        /// <summary>
        /// [28]  	ValuesClause	  ::=  	( 'VALUES' DataBlock )?
        /// </summary>
        static readonly Func<Production> ValuesClause = () => _("ValuesClause", Optional(All(Named("operation", i("VALUES")), @GroupOperation), DataBlock));

        /// <summary>
        /// [29]  	Update	  ::=  	Prologue ( Update1 ( ';' Update )? )?
        /// </summary>
        static readonly Func<Production> Update = () => _("Update", All(Prologue, Optional(Update1, Optional(';', Update))));

        /// <summary>
        /// [30]  	Update1	  ::=  	Load | Clear | Drop | Add | Move | Copy | Create | InsertData | DeleteData | DeleteWhere | Modify
        /// </summary>
        static readonly Func<Production> Update1 = () => _("Update1", AnyOf(Load, Clear, Drop, Add, Move, Copy, Create, InsertData, DeleteData, DeleteWhere, Modify));

        /// <summary>
        /// [31]  	Load	  ::=  	'LOAD' 'SILENT'? iri ( 'INTO' GraphRef )?
        /// </summary>
        static readonly Func<Production> Load = () => _("Load", All(i("LOAD"), Optional(i("SILENT")), iri, Optional(i("INTO"), GraphRef)));

        /// <summary>
        /// [32]  	Clear	  ::=  	'CLEAR' 'SILENT'? GraphRefAll
        /// </summary>
        static readonly Func<Production> Clear = () => _("Clear", All(i("CLEAR"), Optional(i("SILENT")), GraphRefAll));

        /// <summary>
        /// [33]  	Drop	  ::=  	'DROP' 'SILENT'? GraphRefAll
        /// </summary>
        static readonly Func<Production> Drop = () => _("Drop", All(i("DROP"), Optional(i("SILENT")), GraphRefAll));

        /// <summary>
        /// [34]  	Create	  ::=  	'CREATE' 'SILENT'? GraphRef
        /// </summary>
        static readonly Func<Production> Create = () => _("Create", All(i("CREATE"), Optional(i("SILENT")), GraphRef));

        /// <summary>
        /// [35]  	Add	  ::=  	'ADD' 'SILENT'? GraphOrDefault 'TO' GraphOrDefault
        /// </summary>
        static readonly Func<Production> Add = () => _("Add", All(i("ADD"), Optional(i("SILENT"), GraphOrDefault, i("TO"), GraphOrDefault)));

        /// <summary>
        /// [36]  	Move	  ::=  	'MOVE' 'SILENT'? GraphOrDefault 'TO' GraphOrDefault
        /// </summary>
        static readonly Func<Production> Move = () => _("Move", All(i("MOVE"), Optional(i("SILENT"), GraphOrDefault, i("TO"), GraphOrDefault)));

        /// <summary>
        /// [37]  	Copy	  ::=  	'COPY' 'SILENT'? GraphOrDefault 'TO' GraphOrDefault
        /// </summary>
        static readonly Func<Production> Copy = () => _("Copy", All(i("COPY"), Optional(i("SILENT"), GraphOrDefault, i("TO"), GraphOrDefault)));

        /// <summary>
        /// [38]  	InsertData	  ::=  	'INSERT DATA' QuadData
        /// </summary>
        static readonly Func<Production> InsertData = () => _("InsertData", All(i("INSERT DATA"), QuadData));

        /// <summary>
        /// [39]  	DeleteData	  ::=  	'DELETE DATA' QuadData
        /// </summary>
        static readonly Func<Production> DeleteData = () => _("DeleteData", All(i("DELETE DATA"), QuadData));

        /// <summary>
        /// [40]  	DeleteWhere	  ::=  	'DELETE WHERE' QuadPattern
        /// </summary>
        static readonly Func<Production> DeleteWhere = () => _("DeleteWhere", All(i("DELETE WHERE"), QuadPattern));
        ...
        /// </summary>
        static readonly Func<Production> DeleteClause = () => _("DeleteClause", All(i("DELETE"), QuadPattern));

        /// <summary>
        /// [43]  	InsertClause	  ::=  	'INSERT' QuadPattern
        /// </summary>
        static readonly Func<Production> InsertClause = () => _("InsertClause", All(i("INSERT"), QuadPattern));

        /// <summary>
        /// [44]  	UsingClause	  ::=  	'USING' ( iri | 'NAMED' iri )
        /// </summary>
        static readonly Func<Production> UsingClause = () => _("UsingClause", All(i("USING"), AnyOf(iri, All(i("NAMED"), iri))));

        /// <summary>
        /// [45]  	GraphOrDefault	  ::=  	'DEFAULT' | 'GRAPH'? iri
        /// </summary>
        static readonly Func<Production> GraphOrDefault = () => _("GraphOrDefault", AnyOf(i("DEFAULT"), All(Optional(i("GRAPH")), iri)));

        /// <summary>
        /// [46]  	GraphRef	  ::=  	'GRAPH' iri
        /// </summary>
        static readonly Func<Production> GraphRef = () => _("GraphRef", All(i("GRAPH"), iri));

        /// <summary>
        /// [47]  	GraphRefAll	  ::=  	GraphRef | 'DEFAULT' | 'NAMED' | 'ALL'
        /// </summary>
        static readonly Func<Production> GraphRefAll = () => _("GraphRefAll", AnyOf(GraphRef, i("DEFAULT"), i("NAMED"), i("ALL")));

        /// <summary>
        /// [48]  	QuadPattern	  ::=  	'{' Quads '}'
        /// </summary>
        static readonly Func<Production> QuadPattern = () =>  _("QuadPattern", All('{', Quads, '}'));

        /// <summary>
        /// [49]  	QuadData	  ::=  	'{' Quads '}'
        /// </summary>
        static readonly Func<Production> QuadData = () => _("QuadData", All('{', Quads, '}'));

        /// <summary>
        /// [50]  	Quads	  ::=  	TriplesTemplate? ( QuadsNotTriples '.'? TriplesTemplate? )*
        /// </summary>
        static readonly Func<Production> Quads = () => _("Quads", All(Optional(TriplesTemplate), ZeroOrMore(QuadsNotTriples, Optional('.'), Optional(TriplesTemplate))));

        /// <summary>
        /// [51]  	QuadsNotTriples	  ::=  	'GRAPH' VarOrIri '{' TriplesTemplate? '}'
        /// </summary>
        static readonly Func<Production> QuadsNotTriples = () => _("QuadsNotTriples", All(i("GRAPH"), VarOrIri, '{', Optional(TriplesTemplate), '}'));

        /// <summary>
        /// [52]  	TriplesTemplate	  ::=  	TriplesSameSubject ( '.' TriplesTemplate? )?
        /// </summary>
        static readonly Func<Production> TriplesTemplate = () => _("TriplesTemplate", All(TriplesSameSubject, Optional('.', Optional(TriplesTemplate))));

        /// <summary>
        /// [53]  	GroupGraphPattern	  ::=  	'{' ( SubSelect | GroupGraphPatternSub ) '}'
        /// </summary>
        static readonly Func<Production> GroupGraphPattern = () => _("GroupGraphPattern", All(@BeginGroupGraphPattern, '{', AnyOf(SubSelect, GroupGraphPatternSub), '}', @EndGroupGraphPattern, CUT));

        /// <summary>
        /// [54]  	GroupGraphPatternSub	  ::=  	TriplesBlock? ( GraphPatternNotTriples '.'? TriplesBlock? )*
        /// </summary>
        static readonly Func<Production> GroupGraphPatternSub = () =>
            _("GroupGraphPatternSub", 
            All(
        ...
        /// </summary>
        static readonly Func<Production> TriplesBlock = () => _("TriplesBlock", All(TriplesSameSubjectPath, Optional('.', Optional(TriplesBlock))));

        /// <summary>
        /// [56]  	GraphPatternNotTriples	  ::=  	GroupOrUnionGraphPattern | OptionalGraphPattern | MinusGraphPattern | GraphGraphPattern | ServiceGraphPattern | Filter | Bind | InlineData
        /// </summary>
        static readonly Func<Production> GraphPatternNotTriples = () =>
            _("GraphPatternNotTriples", AnyOf(GroupOrUnionGraphPattern, OptionalGraphPattern, MinusGraphPattern, GraphGraphPattern, ServiceGraphPattern, _Filter, _Bind, InlineData));

        /// <summary>
        /// [57]  	OptionalGraphPattern	  ::=  	'OPTIONAL' GroupGraphPattern
        /// </summary>
        static readonly Func<Production> OptionalGraphPattern = () => _("OptionalGraphPattern", All(Named("operation", i("OPTIONAL")), @GroupOperation, GroupGraphPattern));

        /// <summary>
        /// [58]  	GraphGraphPattern	  ::=  	'GRAPH' VarOrIri GroupGraphPattern
        /// </summary>
        static readonly Func<Production> GraphGraphPattern = () => _("GraphGraphPattern", All(Named("operation", i("GRAPH")), @GroupOperation, VarOrIri, GroupGraphPattern));

        /// <summary>
        /// [59]  	ServiceGraphPattern	  ::=  	'SERVICE' 'SILENT'? VarOrIri GroupGraphPattern
        /// </summary>
        static readonly Func<Production> ServiceGraphPattern = () => _("ServiceGraphPattern", All(Named("operation", i("SERVICE")), @GroupOperation, Optional(i("SILENT")), VarOrIri, GroupGraphPattern));

        /// <summary>
        /// [60]  	Bind	  ::=  	'BIND' '(' Expression 'AS' Var ')'
        /// </summary>
        static readonly Func<Production> _Bind = () => _("Bind", All(i("BIND"), '(', Expression, @Bind, i("AS"), Named("bindvar", Var), ')', @BindAsVar));

        /// <summary>
        /// [61]  	InlineData	  ::=  	'VALUES' DataBlock
        /// </summary>
        static readonly Func<Production> InlineData = () => _("InlineData", All(Named("operation", i("VALUES")), @GroupOperation, DataBlock));

        /// <summary>
        /// [62]  	DataBlock	  ::=  	InlineDataOneVar | InlineDataFull
        /// </summary>
        static readonly Func<Production> DataBlock = () => _("DataBlock", AnyOf(InlineDataOneVar, InlineDataFull));
        ...
        /// </summary>
        static readonly Func<Production> MinusGraphPattern = () => _("MinusGraphPattern", All(Named("operation", i("MINUS")), @GroupOperation, GroupGraphPattern));

        /// <summary>
        /// [67]  	GroupOrUnionGraphPattern	  ::=  	GroupGraphPattern ( 'UNION' GroupGraphPattern )*
        /// </summary>
        static readonly Func<Production> GroupOrUnionGraphPattern = () => _("GroupOrUnionGraphPattern", All(GroupGraphPattern, ZeroOrMore(Named("operation", i("UNION")), @GroupOperation, GroupGraphPattern)));

        /// <summary>
        /// [68]  	Filter	  ::=  	'FILTER' Constraint
        /// </summary>
        static readonly Func<Production> _Filter = () => _("Filter", All(i("FILTER"), Constraint, @Filter));

        /// <summary>
        /// [69]  	Constraint	  ::=  	BrackettedExpression | BuiltInCall | FunctionCall
        /// </summary>
        static readonly Func<Production> Constraint = () => _("Constraint", AnyOf(BrackettedExpression, BuiltInCall, FunctionCall));

        /// <summary>
        /// [70]  	FunctionCall	  ::=  	iri ArgList
        /// </summary>
        static readonly Func<Production> FunctionCall = () => _("FunctionCall", All(iri, ArgList));

        /// <summary>
        /// [71]  	ArgList	  ::=  	NIL | '(' 'DISTINCT'? Expression ( ',' Expression )* ')'
        /// </summary>
        static readonly Func<Production> ArgList = () => _("ArgList", AnyOf(NIL, All('(', Optional(i("DISTINCT")), Expression, ZeroOrMore(',', Expression), ')')));

        /// <summary>
        /// [72]  	ExpressionList	  ::=  	NIL | '(' Expression ( ',' Expression )* ')'
        /// </summary>
        static readonly Func<Production> ExpressionList = () => 
            _("ExpressionList", All(@ArgInit, AnyOf(NIL, All('(', Expression, @Arg, ZeroOrMore(',', @Arg, Expression), ')'))));

        /// <summary>
        /// [73]  	ConstructTemplate	  ::=  	'{' ConstructTriples? '}'
        /// </summary>
        static readonly Func<Production> ConstructTemplate = () => _("ConstructTemplate", All(@BeginGroupGraphPattern, '{', Optional(ConstructTriples), '}', @EndGroupGraphPattern));

        /// <summary>
        /// [74]  	ConstructTriples	  ::=  	TriplesSameSubject ( '.' ConstructTriples? )?
        /// </summary>
        static readonly Func<Production> ConstructTriples = () => _("ConstructTriples", All(TriplesSameSubject, Optional('.', ConstructTriples)));

        /// <summary>
        /// [75]  	TriplesSameSubject	  ::=  	VarOrTerm PropertyListNotEmpty |	TriplesNode PropertyList
        /// </summary>
        static readonly Func<Production> TriplesSameSubject = () => 
            _("TriplesSameSubject", 
                AnyOf(
        ...
        /// </summary>
        static readonly Func<Production> PropertyList = () => _("PropertyList", Optional(PropertyListNotEmpty));

        /// <summary>
        /// [77]  	PropertyListNotEmpty	  ::=  	Verb ObjectList ( ';' ( Verb ObjectList )? )*
        /// </summary>
        static readonly Func<Production> PropertyListNotEmpty = () => 
            _("PropertyListNotEmpty", All(Verb, ObjectList, ZeroOrMore(';', Optional(Verb, ObjectList))));

        /// <summary>
        /// [78]  	Verb	  ::=  	VarOrIri | 'a'
        /// </summary>
        static readonly Func<Production> Verb = () => _("Verb", All(Named("predicate", AnyOf(VarOrIri, _A)), @Predicate));

        /// <summary>
        /// [79]  	ObjectList	  ::=  	Object ( ',' Object )*
        /// </summary>
        static readonly Func<Production> ObjectList = () => _("ObjectList", All(_Object, ZeroOrMore(',', _Object)));

        /// <summary>
        /// [80]  	Object	  ::=  	GraphNode
        /// </summary>
        static readonly Func<Production> _Object = () => _("Object", GraphNode);

        /// <summary>
        /// [81]  	TriplesSameSubjectPath	  ::=  	VarOrTerm PropertyListPathNotEmpty |	TriplesNodePath PropertyListPath
        /// </summary>
        static readonly Func<Production> TriplesSameSubjectPath = () =>
            _("TriplesSameSubjectPath", 
                AnyOf(
        ...
        /// </summary>
        static readonly Func<Production> PropertyListPath = () => _("PropertyListPath", Optional(PropertyListPathNotEmpty));

        /// <summary>
        /// [83]  	PropertyListPathNotEmpty	  ::=  	( VerbPath | VerbSimple ) ObjectListPath ( ';' ( ( VerbPath | VerbSimple ) ObjectList )? )*
        /// </summary>
        static readonly Func<Production> PropertyListPathNotEmpty = () => 
            _("PropertyListPathNotEmpty", All(AnyOf(VerbPath, VerbSimple), ObjectListPath, ZeroOrMore(';', Optional(AnyOf(VerbPath, VerbSimple), ObjectList))));

        /// <summary>
        /// [84]  	VerbPath	  ::=  	Path
        /// </summary>
        static readonly Func<Production> VerbPath = () => _("VerbPath", Path);

        /// <summary>
        /// [85]  	VerbSimple	  ::=  	Var
        /// </summary>
        static readonly Func<Production> VerbSimple = () => _("VerbSimple", All(Named("predicate", Var), @Predicate));

        /// <summary>
        /// [86]  	ObjectListPath	  ::=  	ObjectPath ( ',' ObjectPath )*
        /// </summary>
        static readonly Func<Production> ObjectListPath = () => _("ObjectListPath", All(ObjectPath, ZeroOrMore(',', ObjectPath)));

        /// <summary>
        /// [87]  	ObjectPath	  ::=  	GraphNodePath
        /// </summary>
        static readonly Func<Production> ObjectPath = () => _("ObjectPath", GraphNodePath);

        /// <summary>
        /// [88]  	Path	  ::=  	PathAlternative
        /// </summary>
        static readonly Func<Production> Path = () => _("Path", PathAlternative);

        /// <summary>
        /// [89]  	PathAlternative	  ::=  	PathSequence ( '|' PathSequence )*
        /// </summary>
        static readonly Func<Production> PathAlternative = () => _("PathAlternative", All(PathSequence, ZeroOrMore('|', PathSequence)));

        /// <summary>
        /// [90]  	PathSequence	  ::=  	PathEltOrInverse ( '/' PathEltOrInverse )*
        /// </summary>
        static readonly Func<Production> PathSequence = () => _("PathSequence", All(PathEltOrInverse, ZeroOrMore('/', PathEltOrInverse)));

        /// <summary>
        /// [91]  	PathElt	  ::=  	PathPrimary PathMod?
        /// </summary>
        static readonly Func<Production> PathElt = () => _("PathElt", Token(All(PathPrimary, Optional(PathMod))));
        
        /// <summary>
        /// [92]  	PathEltOrInverse	  ::=  	PathElt | '^' PathElt
        /// </summary>
        static readonly Func<Production> PathEltOrInverse = () => _("PathEltOrInverse", AnyOf(PathElt, All('^', PathElt)));

        /// <summary>
        /// [93]  	PathMod	  ::=  	'?' | '*' | '+'
        /// </summary>
        static readonly Func<Production> PathMod = () => _("PathMod", In('?', '*', '+'));
        ...
        static readonly Func<Production> PathNegatedPropertySet = () =>
            _("PathNegatedPropertySet", AnyOf(PathOneInPropertySet, All('(', Optional(PathOneInPropertySet, ZeroOrMore('|', PathOneInPropertySet)), ')')));
        
        /// <summary>
        /// [96]  	PathOneInPropertySet	  ::=  	iri | 'a' | '^' ( iri | 'a' )
        /// </summary>
        static readonly Func<Production> PathOneInPropertySet = () => _("PathOneInPropertySet", AnyOf(iri, _A, All('^', AnyOf(iri, _A))));

        /// <summary>
        /// [97]  	Integer	  ::=  	INTEGER
        /// </summary>
        static readonly Func<Production> _Integer = () => _("Integer", INTEGER);
        
        /// <summary>
        /// [98]  	TriplesNode	  ::=  	Collection |	BlankNodePropertyList
        /// </summary>
        static readonly Func<Production> TriplesNode = () => _("TriplesNode", AnyOf(Collection, BlankNodePropertyList));
        
        /// <summary>
        /// [99]  	BlankNodePropertyList	  ::=  	'[' PropertyListNotEmpty ']'
        /// </summary>
        static readonly Func<Production> BlankNodePropertyList = () => _("BlankNodePropertyList", All(@BeginPropertyList, '[', PropertyListNotEmpty, ']', @EndPropertyList));

        /// <summary>
        /// [100]  	TriplesNodePath	  ::=  	CollectionPath |	BlankNodePropertyListPath
        /// </summary>
        static readonly Func<Production> TriplesNodePath = () => _("TriplesNodePath", AnyOf(CollectionPath, BlankNodePropertyListPath));

        /// <summary>
        /// [101]  	BlankNodePropertyListPath	  ::=  	'[' PropertyListPathNotEmpty ']'
        /// </summary>
        static readonly Func<Production> BlankNodePropertyListPath = () => _("BlankNodePropertyListPath", All(@BeginPropertyList, '[', PropertyListPathNotEmpty, ']', @EndPropertyList));

        /// <summary>
        /// [102]  	Collection	  ::=  	'(' GraphNode+ ')'
        /// </summary>
        static readonly Func<Production> Collection = () => _("Collection", All(@BeginCollection, '(', OneOrMore(GraphNode), ')', @EndCollection));

        /// <summary>
        /// [103]  	CollectionPath	  ::=  	'(' GraphNodePath+ ')'
        /// </summary>
        static readonly Func<Production> CollectionPath = () => _("CollectionPath", All(@BeginCollection, '(', OneOrMore(GraphNodePath), ')', @EndCollection));
        
        /// <summary>
        /// [104]  	GraphNode	  ::=  	VarOrTerm |	TriplesNode
        /// </summary>
        static readonly Func<Production> GraphNode = () => _("GraphNode", AnyOf(All(Named("object", VarOrTerm), @Object), All(@AllocAnonObject, TriplesNode)));

        /// <summary>
        /// [105]  	GraphNodePath	  ::=  	VarOrTerm |	TriplesNodePath
        /// </summary>
        static readonly Func<Production> GraphNodePath = () => _("GraphNodePath", AnyOf(All(Named("object", VarOrTerm), @Object), All(@AllocAnonObject, TriplesNodePath)));

        /// <summary>
        /// [106]  	VarOrTerm	  ::=  	Var | GraphTerm
        /// </summary>
        static readonly Func<Production> VarOrTerm = () => _("VarOrTerm", AnyOf(Var, GraphTerm));

        /// <summary>
        /// [107]  	VarOrIri	  ::=  	Var | iri
        /// </summary>
        static readonly Func<Production> VarOrIri = () => _("VarOrIri", AnyOf(Var, iri));

        /// <summary>
        /// [108]  	Var	  ::=  	VAR1 | VAR2
        /// </summary>
        static readonly Func<Production> Var = () => _("Var", All(AnyOf(VAR1, VAR2), @Variable));
        
        /// <summary>
        /// [109]  	GraphTerm	  ::=  	iri |	RDFLiteral |	NumericLiteral |	BooleanLiteral |	BlankNode |	NIL
        /// </summary>
        static readonly Func<Production> GraphTerm = () => _("GraphTerm", AnyOf(iri, RDFLiteral, NumericLiteral, BooleanLiteral, BlankNode, Named("node", NIL)));
        ...
        /// </summary>
        static readonly Func<Production> Expression = () => _("Expression", ConditionalOrExpression);

        /// <summary>
        /// [111]  	ConditionalOrExpression	  ::=  	ConditionalAndExpression ( '||' ConditionalAndExpression )*
        /// </summary>
        static readonly Func<Production> ConditionalOrExpression = () => 
            _("ConditionalOrExpression", All(ConditionalAndExpression, ZeroOrMore("||", ConditionalAndExpression, @OperatorOr)));
        
        /// <summary>
        /// [112]  	ConditionalAndExpression	  ::=  	ValueLogical ( '&&' ValueLogical )*
        /// </summary>
        static readonly Func<Production> ConditionalAndExpression = () => _("ConditionalAndExpression", All(ValueLogical, ZeroOrMore("&&", ValueLogical, @OperatorAnd)));
        
        /// <summary>
        /// [113]  	ValueLogical	  ::=  	RelationalExpression
        /// </summary>
        static readonly Func<Production> ValueLogical = () => _("ValueLogical", RelationalExpression);
        ...
        /// </summary>
        static readonly Func<Production> NumericExpression = () => _("NumericExpression", AdditiveExpression);
        ...
        /// </summary>
        static readonly Func<Production> BrackettedExpression = () => _("BrackettedExpression", All('(', Expression, ')'));
        ...
        static readonly Func<Production> RegexExpression = () =>
            _("RegexExpression", All(i("REGEX"), '(', Expression, ',', Expression, Optional(',', Expression), ')'));
        
        /// <summary>
        /// [123]  	SubstringExpression	  ::=  	'SUBSTR' '(' Expression ',' Expression ( ',' Expression )? ')'
        /// </summary>
        static readonly Func<Production> SubstringExpression = () =>
            _("SubstringExpression", All(i("SUBSTR"), '(', Expression, ',', Expression, AnyOf(@SUBSTR2, Optional(',', Expression, @SUBSTR3)), ')'));

        /// <summary>
        /// [124]  	StrReplaceExpression	  ::=  	'REPLACE' '(' Expression ',' Expression ',' Expression ( ',' Expression )? ')'
        /// </summary>
        static readonly Func<Production> StrReplaceExpression = () => 
            _("StrReplaceExpression", All(i("REPLACE"), '(', Expression, ',', Expression, ',', Expression, AnyOf(@REPLACE3, Optional(',', Expression, @REPLACE4),')')));

        /// <summary>
        /// [125]  	ExistsFunc	  ::=  	'EXISTS' GroupGraphPattern
        /// </summary>
        static readonly Func<Production> ExistsFunc = () => _("ExistsFunc", All(Named("operation", i("EXISTS")), @GroupOperation, GroupGraphPattern));

        /// <summary>
        /// [126]  	NotExistsFunc	  ::=  	'NOT' 'EXISTS' GroupGraphPattern
        /// </summary>
        static readonly Func<Production> NotExistsFunc = () => _("NotExistsFunc", All(i("NOT"), i("EXISTS"), SetName("operation", "NOTEXISTS", @GroupOperation), GroupGraphPattern));
        ...
        static readonly Func<Production> AggregateDistinct = () => _("AggregateDistinct", AnyOf(All(i("DISTINCT"), @AggDistinct), @AggNotDistinct));
        #endregion

        /// <summary>
        /// [128]  	iriOrFunction	  ::=  	iri ArgList?
        /// </summary>
        static readonly Func<Production> iriOrFunction = () => _("iriOrFunction", All(iri, Optional(ArgList)));

        /// <summary>
        /// [129]  	RDFLiteral	  ::=  	String ( LANGTAG | ( '^^' iri ) )?
        /// </summary>
        static readonly Func<Production> RDFLiteral = () => _("RDFLiteral", Named("node", All(Token(_String, Optional(AnyOf(LANGTAG, All("^^", iri)))), @String)));
        ...
        /// </summary>
        static readonly Func<Production> BooleanLiteral = () => _("BooleanLiteral", All(AnyOf("true", "false"), @Boolean));

        /// <summary>
        /// [135]  	String	  ::=  	STRING_LITERAL1 | STRING_LITERAL2 | STRING_LITERAL_LONG1 | STRING_LITERAL_LONG2
        /// </summary>
        static readonly Func<Production> _String = () => _("String", Token(AnyOf(STRING_LITERAL1, STRING_LITERAL2, STRING_LITERAL_LONG1, STRING_LITERAL_LONG2)));
        
        /// <summary>
        /// [136]  	iri	  ::=  	IRIREF |	PrefixedName
        /// </summary>
        static readonly Func<Production> iri = () => _("iri", All(AnyOf(IRIREF, PrefixedName), @Iri));
        
        /// <summary>
        /// [137]  	PrefixedName	  ::=  	PNAME_LN | PNAME_NS
        /// </summary>
        static readonly Func<Production> PrefixedName = () => _("PrefixedName", Token(AnyOf(PNAME_LN, PNAME_NS)));
        ...
        /// [161]  	NIL	  ::=  	'(' WS* ')'
        /// </summary>
        static readonly Func<Production> NIL = () => _("NIL", All('(', ZeroOrMore(WS), ')', @Nil));
        ...
        /// [163]  	ANON	  ::=  	'[' WS* ']'
        /// </summary>
        static readonly Func<Production> ANON = () => _("ANON", All('[', WHITESPACE, ']'));
