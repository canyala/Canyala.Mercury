...
namespace Canyala.Mercury.Rdf.Internal
{
    ...
    public class BuiltIns
    {
        ...
        public BuiltIns()
        {
            Blanks = new Dictionary<string, Blank>();
        ...
        {
            var simpleTag = languageTag as Literal;
            var simpleRange = languageRange as Literal;
        ...
        public Resource BNODE(Resource res)
        {
            ...
            {
                Blank knownBlank;
                if (!Blanks.TryGetValue(literal.Value, out knownBlank))
